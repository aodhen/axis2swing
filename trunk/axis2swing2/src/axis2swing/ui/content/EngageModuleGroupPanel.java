...
public class EngageModuleGroupPanel extends PanelContent
{
	...
	protected void initGUI()
	{
		...
		String message = "<html><p>To engage a module for a set of services grouped as "
				+ "an axis service group,</p><ol>"
		...
		if (lstModule != null && !lstModule.isEmpty() && lstGroup != null)
		{
			...
			newButton.addActionListener(new ActionListener() {
				...
				{
					if (controller.engageModuleGroup(cmbModule
							.getSelectedItem().toString(), cmbGroup
